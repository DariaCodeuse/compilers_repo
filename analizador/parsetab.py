...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','app.py',9),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','app.py',10),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','app.py',11),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','app.py',12),
  ('expression -> NUMBER','expression',1,'p_expression_number','app.py',23),
]
